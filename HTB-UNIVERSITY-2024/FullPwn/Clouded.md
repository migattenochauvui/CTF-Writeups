...
![Website upload page](/HTB-UNIVERSITY-2024/FullPwn/images/website_upload_page.png)
...
![AWS lambda](/HTB-UNIVERSITY-2024/FullPwn/images/aws_lambda.png)
...
![AWS login](/HTB-UNIVERSITY-2024/FullPwn/images/aws_login.png)
...
![Database](/HTB-UNIVERSITY-2024/FullPwn/images/database.png)
...
![handler function upload](/HTB-UNIVERSITY-2024/FullPwn/images/handler_function.png)

We can see that we successfully uploaded our function and we have executed using `lambda invoke`

![lambda revshell](/HTB-UNIVERSITY-2024/FullPwn/images/lambda_revshell.png)
...
![hydra](/HTB-UNIVERSITY-2024/FullPwn/images/hydra.png)

We can now ssh login onto the machine and find the first flag !

![userflag](/HTB-UNIVERSITY-2024/FullPwn/images/userflag1.png)
...
![playbook](/HTB-UNIVERSITY-2024/FullPwn/images/playbook.png)
...
![rootflag](/HTB-UNIVERSITY-2024/FullPwn/images/rootflag1.png)
